...
comment_post <- read.csv2("C:\Users\Revi\Documents\dataviz_04_20/Comment-Post/comments2_all.csv",sep=",",header=TRUE)
dataset2 <- dataset2 %>% left_join(comment_post, by=c("infected_comment"))

#Agregar id de parent comment
comment_parent <- read.csv2("C:\Users\Revi\Documents\dataviz_04_20/Comment-Parent/comment_parents.csv",sep=",",header=TRUE)
